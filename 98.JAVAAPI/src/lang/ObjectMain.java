...
public class ObjectMain {
	...
	public static void main(String[] args) {
		/*
		 * /* << Object >> Object 클래스는 클래스 계층 루트입니다. 모든 클래스는 슈퍼 클래스로서 Object를 가집니다. 배열을
		 * 포함한 모든 객체는 이 클래스의 메서드를 구현합니다.
		 * 
		...
		Object o3 = o1;
		/*
		 * << Object >> public String toString(); Returns: a string representation of
		 * the object.
		 * 
		 */
		...
		/*
		 * << Object >> public boolean equals(Object obj); - Indicates whether some
		 * other object is "equal to" this one. - 주소가 동일한지비교 Parameters: obj - the
