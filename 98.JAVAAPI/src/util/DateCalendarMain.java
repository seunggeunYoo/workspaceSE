...
public class DateCalendarMain {
	...
	public static void main(String[] args)throws Exception {
		...
		long startTime = System.currentTimeMillis();/*Method start*/
		Thread.sleep(12);/*nano time*/
		...
		System.out.println("-----SimpleDateFormat[String->Date]------------");/*이거 중요*/
		...
		System.out.println(y+"/"+month+"/"+day+" "+hour+":"+second+"."+msecond);
		...
		System.out.println("calendat cal3 -->"+cal3);
		
		System.out.println("----------------Date객체메쏘드-------------------");/*이거 중요*/
		...
		System.out.println("java.util.Date--> java.sql.Date -------------");/*이거 중요*/
		...
		System.out.println("java.sql.Date--> java.util.Date -------------");/*잘 사용하지 않음*/
		/*urrentTimeMillis sql 할때 무조건 넣어주세요.*/
