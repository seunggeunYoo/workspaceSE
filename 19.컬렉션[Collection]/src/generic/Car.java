...
public class Car {
	/*
	 * 클래스의 구성요소 1.멤버필드(변수)[속성]: 차객체의 속성데이타를 저장할변수 2.멤버메쏘드[기능] : 차객체가 외부에제공하는기능
	 */
	/*
	 * 멤버필드[속성]
	 */
	...
	/*
	 * 차량번호,입차시간을 인자로 받아서 멤버필드의 값을 가진차객체생성
	 */
	/**
	 * 입차데이타로 초기화된 차량객체
	 * 
	...
	/*
	 * 차량멤버데이타를 인자로받아서 멤버필드의 값을 가진차객체생성
	 */
	/**
	 * 메개변수로 초기화된 차량객체생성
	 * 
	...
	/*
	 * getter,setter메쏘드 자동생성단축키 alt+shift+s --> r
	 */
	public String getNo() {
		return no;
	}
