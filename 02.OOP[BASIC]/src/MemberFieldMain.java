...
public class MemberFieldMain {
	...
	public static void main(String[] args) {
		 ...
		 */
		MemberField mf1;// 위치 값
		/*
		 * MemberField클래스(틀)로 객체생성한후에 객체의 참조변수 mf1에 생성된 객체의 주소값이 대입(#100)
		 */
		mf1 = new MemberField(); //
		 ...
		 * mf1(#100)주소에있는 객체의 double	타입의 멤버변수 member2에 	3.14199				값을 대입
		 * mf1(#100)주소에있는 객체의 char		타입의 멤버변수 member3에 	'A'					값을 대입
		 * mf1(#100)주소에있는 객체의 String	타입의 멤버변수 member4에 	김수한무거북이~~	값을 대입
		 * 
		 * - 객체의 참조(주소)변수가 가지고 있는 객체의 주소값 #100를 사용해서 멤버필드에 데이타대입
		 * - 객체의 멤버필드접근방법
		 *  - 참조(주소)변수.멤버필드이름 = 값;
		 *  - ex) mf1.member1=77; 
		 */
		 ...
		 * 
		 * - 객체의 참조(주소)변수가 가지고 있는 객체의 주소값 #100를 사용해서 멤버필드의 값출력
		 * - 객체의 멤버필드접근방법
		 ...
		 * 
		 */
		System.out.println("mf1의주소값:"+mf1);//MemberField@15db9742 ->@15db9742 이것이 주소값
		...
		MemberField mf2 = new MemberField();//주소값을 저장할 객체값이다.
		mf2.member1=88;
