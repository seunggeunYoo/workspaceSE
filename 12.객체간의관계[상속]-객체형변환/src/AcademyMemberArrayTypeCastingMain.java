...
public class AcademyMemberArrayTypeCastingMain {
	...
	public static void main(String[] args) {
		...
		*/
		...
		AcademyMember[] receiveMembers = members;/*receiveMembers 이거를 만들어놓으므로써 계속 AcademyMember값을 사용할수 있다*/
		...
		System.out.println("-------------AcademyMember배열에 있는 객체들중에서 AcademyStudent 객체들만출력------------");
		for(int i=0;i<receiveMembers.length;i++) {
