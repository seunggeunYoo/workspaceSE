...
public class FileMain {
	...
	public static void main(String[] args)throws Exception {
		...
		File file3 = new File("sample/subSample/00.CariableDeclare.txt");
		File file4 = new File("C:\\2022-11-JAVA-DEVELOPER\\workspaceSE\\20.입출력[IO]\\sample\\");
		...
		System.out.println("----------2.file absoulute path---------------");
		...
		File[] rootDriverFileList=File.listRoots();
		for (File file : rootDriverFileList) {
			System.out.println(file.getPath());
		}
		System.out.println("c:/파일목록출력");
		File cDrive=rootDriverFileList[0];
		File[] cDriverFileList = cDrive.listFiles();
		for (File file : cDriverFileList) {
